#!/bin/bash
###############################################################################
# Script Name  : sftp_count_table_drc.sh
# Description  : sftp file count 192.168.140.30 -> 10.13.2.252.
# Server       : DB DRC
...
SRC_FILE="/export/home/oracle/scripts/automation/output_count/output_count_table_drc.csv"
DEST_HOST="10.13.2.252"
DEST_USER="oracle"
